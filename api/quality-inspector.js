...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    await logUsage({churchId,userId:authUser.id,operationType:'quality-inspector',model:'gpt-5.6-sol',endpoint:'responses',usage:d.usage,metadata:{...costContextFromData(data),requestId,mode:data.mode||null}});
